      ...
      <div className="flex-1 lg:w-1/2 flex items-center justify-center p-6 sm:p-8 bg-gradient-to-br from-gray-50 to-gray-100/50">
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          <div className="text-center mb-8">
            <div className="lg:hidden mx-auto w-16 h-16 bg-gradient-to-br from-blue-600 to-blue-700 rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-blue-500/20">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-200/50 backdrop-blur-sm">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Button
                ...
                disabled={isLoading}
                size="lg"
                className="w-full h-12 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-lg transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/40 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 mt-6"
              >
                {isLoading ? (
